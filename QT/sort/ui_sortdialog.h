...
public:
    ...
    void retranslateUi(QDialog *SortDialog)
    {
        ...
        primaryGroupBox->setTitle(QApplication::translate("SortDialog", "&PrimaryKey", Q_NULLPTR));
        ...
        secondaryGroupBox->setTitle(QApplication::translate("SortDialog", "&SecondaryKey", Q_NULLPTR));
        ...
        tertiaryGroupBox->setTitle(QApplication::translate("SortDialog", "&TertiaryKey", Q_NULLPTR));
