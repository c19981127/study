...
(cl:in-package chatpter2_tutorials-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <chapter2_srv1-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'chapter2_srv1-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chatpter2_tutorials-srv:<chapter2_srv1-request> is deprecated: use chatpter2_tutorials-srv:chapter2_srv1-request instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <chapter2_srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-srv:A-val is deprecated.  Use chatpter2_tutorials-srv:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <chapter2_srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-srv:B-val is deprecated.  Use chatpter2_tutorials-srv:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <chapter2_srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-srv:C-val is deprecated.  Use chatpter2_tutorials-srv:C instead.")
  (C m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<chapter2_srv1-request>)))
  ...
  "chatpter2_tutorials/chapter2_srv1Request")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'chapter2_srv1-request)))
  "Returns string type for a service object of type 'chapter2_srv1-request"
  "chatpter2_tutorials/chapter2_srv1Request")
...
(cl:defmethod cl:initialize-instance :after ((m <chapter2_srv1-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'chapter2_srv1-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chatpter2_tutorials-srv:<chapter2_srv1-response> is deprecated: use chatpter2_tutorials-srv:chapter2_srv1-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <chapter2_srv1-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-srv:sum-val is deprecated.  Use chatpter2_tutorials-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<chapter2_srv1-response>)))
  ...
  "chatpter2_tutorials/chapter2_srv1Response")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'chapter2_srv1-response)))
  "Returns string type for a service object of type 'chapter2_srv1-response"
  "chatpter2_tutorials/chapter2_srv1Response")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'chapter2_srv1)))
  ...
  "chatpter2_tutorials/chapter2_srv1")