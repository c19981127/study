...
(cl:in-package chatpter2_tutorials-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <chapter2_msg1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'chapter2_msg1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chatpter2_tutorials-msg:<chapter2_msg1> is deprecated: use chatpter2_tutorials-msg:chapter2_msg1 instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <chapter2_msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-msg:A-val is deprecated.  Use chatpter2_tutorials-msg:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <chapter2_msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-msg:B-val is deprecated.  Use chatpter2_tutorials-msg:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <chapter2_msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatpter2_tutorials-msg:C-val is deprecated.  Use chatpter2_tutorials-msg:C instead.")
  (C m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<chapter2_msg1>)))
  ...
  "chatpter2_tutorials/chapter2_msg1")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'chapter2_msg1)))
  "Returns string type for a message object of type 'chapter2_msg1"
  "chatpter2_tutorials/chapter2_msg1")
